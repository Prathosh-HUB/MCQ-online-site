              ...
              >
                ...
                {question.questionType === "FILL_BLANKS" ? (
                  <div className="space-y-3 mb-4">
                    <div className="flex items-center gap-3 p-4 rounded-lg border bg-white/5 border-white/10">
                      ...
                      {/* <div className="flex-1">
                        <p className="text-xs text-slate-500 mb-1">Reference Answer</p>
                        <p className="text-base font-medium text-amber-400">{question.correctAnswer}</p>
                      </div> */}
                    </div>
                  </div>
                ) : (
